          ...
          <div className="space-y-12 md:space-y-24">
            {pasos.map((paso, i) => {
              ...
              return (
                ...
                >
                  {/* Mobile: todo junto a la izquierda */}
                  ...
                  <div className="hidden md:contents">
                    {/* Left column */}
                    <div className={`flex-1 ${isEven ? "text-right pr-12" : "order-3 pl-12"}`}>
                    ...
                    {/* Right column - empty spacer when content is on left */}
                    <div className={`flex-1 ${isEven ? "order-3" : ""}`} />
                  </div>
                </motion.div>
              );
            })}
